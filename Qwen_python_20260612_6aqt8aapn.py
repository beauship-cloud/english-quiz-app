...
# ==========================================================
# 📚 2025년 7월(Jul 2025) 핵심 표현 학습 데이터 (54개)
# ==========================================================
QUIZ_DATA = [
...
if st.session_state.quiz_finished:
    ...
    with st.sidebar:
        ...
        st.divider()
        if st.button("🔄 즈 리셋", use_container_width=True):
            reset_quiz()
            st.rerun()

    # 힌트 표시 (핵심 표현 부분 볼드 처리를 위해 마크다운 사용)
    st.markdown(f"### 💡 트: {current_q['hint']}")
